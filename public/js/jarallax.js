...
var Jarallax = function () {
    function Jarallax(item, userOptions) {
        ...
        self.defaults = {
            ...
            imgSrc: null,
            imgElement: '.jarallax-images',
            imgSize: 'cover',
            imgPosition: '50% 50%',
            imgRepeat: 'no-repeat', // supported only for background, not for <images> tag
            keepImg: false, // keep <images> tag in it's default place
    ...
    _createClass(Jarallax, [{
        ...
        value: function destroy() {
            ...
            if (self.image.useImgTag) {
                // return styles on images tag as before jarallax init
                ...
                // move images tag to its default position
